    ...
    def Receive_Anl(self, rx):
        if rx.date[0] == 1:
            ...
            if id < self.maxNum:
                ...
                self.flySensor[id].obs_dist = [
                    pack[5],
                    pack[6],
                    pack[7],
                    pack[8]]
                self.flySensor[id].imu = [
                    pack[9] * 0.1,
                    pack[10] * 0.1,
                    pack[11] * 0.1]
                self.flySensor[id].loc = [
                    pack[12],
                    pack[13],
                    pack[14]]
                self.flySensor[id].locErr = [
                    pack[15],
                    pack[16],
                    pack[17]]
                self.flySensor[id].orderCount = pack[18]
                if self.photo.id == id:
                    ...
                    if id < self.maxNum:
                        ...
                        elif rx.date[0] == 244 and rx.date[0] == 245 and rx.date[0] == 246 or rx.date[0] == 255:
